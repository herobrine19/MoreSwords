...
public class SwordMaterial
{
    ...
    public static final Item.ToolMaterial LIGHT = EnumHelper.addToolMaterial("LIGHT", 3, 1000, 16.0F, 3.0F, 100).setRepairItem(new ItemStack(Items.GLOWSTONE_DUST));
    public static final Item.ToolMaterial WIND = EnumHelper.addToolMaterial("WIND", 3, 1000, 16.0F, 3.0F, 100).setRepairItem(new ItemStack(Items.GHAST_TEAR));
}
